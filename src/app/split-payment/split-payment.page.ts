...
export class SplitPaymentPage implements OnInit {
  ...
  creditDebitType: any = '';
 isSplitPaymentProcessing = false;
lang:any;
  ngOnInit() {
  ...
  closePopover() {
    ...
    async paySplitPayment() {
  if (this.isSplitPaymentProcessing) {
    return;
  }

  this.isSplitPaymentProcessing = true;
   ...
   this.isSplitPaymentProcessing = false;
